...
const ContactPage = () => {
    ...
    // Common Paper sx for all three containers
    const paperSx = {
        borderRadius: 3,
    ...
    // Paper sx for hover effect (center and right only)
    const hoverPaperSx = {
        ...paperSx,
        '&:hover': {
    ...
    // Custom TextField styles for green focus
    const textFieldSx = {
        '& label.Mui-focused': {
            color: green,
        },
        ...
        <Box sx={{ pt: 10, pb: 5, backgroundColor: '#fff', minHeight: '100vh' }}>
            <Container maxWidth="lg">
                <Grid
                    ...
                    alignItems="stretch"
                    wrap="nowrap"
                    sx={{ minHeight: 400, justifyContent: 'center' }}
                >
                    {/* Left: Form */}
                    <Grid item xs={12} md={4} sx={{ display: 'flex', width: '40%' }}>
                        <Paper
                            elevation={3}
                            sx={{
                                ...paperSx,
